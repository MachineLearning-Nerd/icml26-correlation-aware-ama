...
def main() -> int:
    ...
    result = api.create_commit(
        ...
        commit_message="Verify Claim 4 with exact five-seed CA-AMA evidence",
        commit_description=(
            "Additive CPU reproduction update promoting Claim 4 to VERIFIED "
            "from five exact full-scale released-AMenuNet seeds, 100,000 raw "
            "test rows, independent recomputation, negative controls, and a "
            "fail-closed verifier. Claim 5 remains honestly BLOCKED. Preserves "
            "the judged and previously published evidence trees."
        ),
    )
